...
//   const [precio, setPrecio] = useState(eventDetail.price);
...
//     console.log('sere title?', eventDetail.name)
//     setBody({
//       userId: activeUser.id,
//       cantidad: cantidad,
//       idEvento: eventDetail.id
//     });
//     console.log('STATE P ENVIAR', state)
//   }
...
//         idEvento: eventDetail.id
//       });
//       console.log('EL STATE TERMINADO?', state)
//       // setState({
//       //   totalPrice: precio,
//       //   title: eventDetail.name,
//       //   quantity: cantidad,
...
//                   <select className={s.select} onChange={(e) => handler(e)}>
...
//                   <div className={s.numeros}>Total: </div>
//                   <div>${precio ? precio : eventDetail.price}</div>
//                 </div>
//                 <button className={s.buy} onClick={() => handleClick(body)}>
//                   <p>COMPRAR</p>
//                 </button>
//               </div>
//             </div>
