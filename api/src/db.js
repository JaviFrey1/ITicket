...
let sequelize =
  process.env.NODE_ENV === "production"
    ...
    : new Sequelize(
        `postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/tukiteck`,
        { logging: false, native: false }
      );
// const sequelize = new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/tukiteck`, {
...
const { Categories, Events, SubCategories, Tickets, Users } = sequelize.models;
